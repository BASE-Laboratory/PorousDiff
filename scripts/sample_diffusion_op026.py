"""
sample_diffusion_op026.py

Generate synthetic 3D TiO2 Op026mVV microstructure samples
...
checkpoint_path = Path(
    f"results/diffusion_checkpoints/ddpm_op026_64_epoch{epoch}_final.pth"
)
...
for i in range(num_samples):
    ...
    output_path = output_dir / f"ddpm_op026_epoch{epoch}_{i + 1}.png"
